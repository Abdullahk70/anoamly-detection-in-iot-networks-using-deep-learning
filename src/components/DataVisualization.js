    ...
    <div className="bg-white rounded-lg shadow-md p-4 w-full max-w-xl mx-auto">
      ...
      <div className="space-y-3">
        ...
        <div className="flex justify-between text-sm">
          ...
          <button className="bg-purple-600 text-white px-3 py-1 rounded-xl font-semibold text-xs w-1/3">
            Me
          </button>
        </div>
        <div className="flex justify-between text-sm">
      ...
      <div className="mt-4 space-y-3">
        ...
        <div className="flex items-center justify-between bg-white p-3 rounded-full border border-gray-300">
          ...
          <button className="bg-purple-600 text-white px-4 py-2 rounded-full text-xs">
            Attach
          </button>
        </div>
